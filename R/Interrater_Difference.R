#' A Function to Automatically Extract Interrater Differences in Annotations
#'
#' This function will loop over annotations in a folder checking for interrater differences in annotations. These differences will be extracted and stored in a new folders downstream to the output directory assigned.
...
#' @param Rater2_Directory Directory of where the annotations were made by the second rater <e.g. "C:/Users/___YOUR USERNAME___/UPSTREAM FOLDER/.../FOLDER NAME/">
#' @param R2_Keyword Specify keywords for the stage files. Make sure to provide the maximum patterns shared among files.
#' @param R2_Type The type of file to import. Currently, supports  ".tsv . <default: ".txt">
#' @param R2_Deliminator If the data is stored in .txt file and the deliminator is not TAB as default, please, specify it. <default: "\t">
#' @param R2 The initial of rater 2.
...
Interrater_Difference <- function(Rater1_Directory, R1_Keyword=FALSE,R1_Type=".txt", R1_Deliminator="\t",R1="",
                               Rater2_Directory, R2_Keyword=FALSE,R2_Type=".txt", R2_Deliminator="\t",R2="",
